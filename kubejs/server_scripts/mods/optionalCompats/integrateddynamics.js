...
if (Platform.isLoaded("integrateddynamics") && Platform.isLoaded("integratedtunnels")) {
    ...
    ServerEvents.recipes(event => {
        ...
        event.recipes.gtceu.cutter("menril_slab_water")
            .itemInputs("integrateddynamics:menril_planks")
            .inputFluids("minecraft:water 4")
            .itemOutputs("2x integrateddynamics:menril_slab")
            .duration(400)
            .EUt(GTValues.VA[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_block_slab_water")
            .itemInputs("integrateddynamics:crystalized_menril_block")
            .inputFluids("minecraft:water 4")
            .itemOutputs("2x integrateddynamics:crystalized_menril_block_slab")
            .duration(80)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_brick_slab_water")
            .itemInputs("integrateddynamics:crystalized_menril_brick")
            .inputFluids("minecraft:water 4")
            .itemOutputs("2x integrateddynamics:crystalized_menril_brick_slab")
            .duration(80)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_slab_distilled_water")
            .itemInputs("integrateddynamics:menril_planks")
            .inputFluids("gtceu:distilled_water 3")
            .itemOutputs("2x integrateddynamics:menril_slab")
            .duration(300)
            .EUt(GTValues.VA[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_block_slab_distilled_water")
            .itemInputs("integrateddynamics:crystalized_menril_block")
            .inputFluids("gtceu:distilled_water 3")
            .itemOutputs("2x integrateddynamics:crystalized_menril_block_slab")
            .duration(60)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_brick_slab_distilled_water")
            .itemInputs("integrateddynamics:crystalized_menril_brick")
            .inputFluids("gtceu:distilled_water 3")
            .itemOutputs("2x integrateddynamics:crystalized_menril_brick_slab")
            .duration(60)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_slab")
            .itemInputs("integrateddynamics:menril_planks")
            .inputFluids("gtceu:lubricant 1")
            .itemOutputs("2x integrateddynamics:menril_slab")
            .duration(200)
            .EUt(GTValues.VA[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_block_slab")
            .itemInputs("integrateddynamics:crystalized_menril_block")
            .inputFluids("gtceu:lubricant 1")
            .itemOutputs("2x integrateddynamics:crystalized_menril_block_slab")
            .duration(40)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("menril_brick_slab")
            .itemInputs("integrateddynamics:crystalized_menril_brick")
            .inputFluids("gtceu:lubricant 1")
            .itemOutputs("2x integrateddynamics:crystalized_menril_brick_slab")
            .duration(40)
        ...
        event.recipes.gtceu.assembler("static_panel")
            .itemInputs("#ae2:illuminated_panel", "8x integrateddynamics:menril_torch", "4x minecraft:glowstone_dust", "#gtceu:circuits/ulv")
            .inputFluids("integrateddynamics:menril_resin 576")
            .circuit(1)
            .itemOutputs("integrateddynamics:part_static_light_panel")
            .duration(200)
            .EUt(GTValues.VA[GTValues.LV])
        event.recipes.gtceu.assembler("static_panel_stone")
            .itemInputs("#ae2:illuminated_panel", "8x integrateddynamics:menril_torch_stone", "4x minecraft:glowstone_dust", "#gtceu:circuits/ulv")
            .inputFluids("integrateddynamics:menril_resin 576")
            .circuit(1)
            .itemOutputs("integrateddynamics:part_static_light_panel")
            .duration(200)
