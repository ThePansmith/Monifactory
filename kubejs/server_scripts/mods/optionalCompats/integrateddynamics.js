...
if (Platform.isLoaded("integrateddynamics") && Platform.isLoaded("integratedtunnels")) {
    ...
    ServerEvents.recipes(event => {
        ...
        event.recipes.gtceu.cutter("menril_brick_slab_water")
            ...
            .duration(80)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("chorus_block_slab_water")
            .itemInputs("integrateddynamics:crystalized_chorus_block")
            .inputFluids("minecraft:water 4")
            .itemOutputs("2x integrateddynamics:crystalized_chorus_block_slab")
            .duration(80)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("chorus_brick_slab_water")
            .itemInputs("integrateddynamics:crystalized_chorus_brick")
            .inputFluids("minecraft:water 4")
            .itemOutputs("2x integrateddynamics:crystalized_chorus_brick_slab")
            .duration(80)
            .EUt(GTValues.V[GTValues.ULV])
        ...
        event.recipes.gtceu.cutter("menril_brick_slab_distilled_water")
            ...
            .duration(60)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("chorus_block_slab_distilled_water")
            .itemInputs("integrateddynamics:crystalized_chorus_block")
            .inputFluids("gtceu:distilled_water 3")
            .itemOutputs("2x integrateddynamics:crystalized_chorus_block_slab")
            .duration(60)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("chorus_brick_slab_distilled_water")
            .itemInputs("integrateddynamics:crystalized_chorus_brick")
            .inputFluids("gtceu:distilled_water 3")
            .itemOutputs("2x integrateddynamics:crystalized_chorus_brick_slab")
            .duration(60)
        ...
        event.recipes.gtceu.cutter("menril_brick_slab")
            ...
            .duration(40)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("chorus_block_slab")
            .itemInputs("integrateddynamics:crystalized_chorus_block")
            .inputFluids("gtceu:lubricant 1")
            .itemOutputs("2x integrateddynamics:crystalized_chorus_block_slab")
            .duration(40)
            .EUt(GTValues.V[GTValues.ULV])
        event.recipes.gtceu.cutter("chorus_brick_slab")
            .itemInputs("integrateddynamics:crystalized_menril_brick")
            .inputFluids("gtceu:lubricant 1")
            .itemOutputs("2x integrateddynamics:crystalized_menril_brick_slab")
            .duration(40)
