if (Platform.isLoaded('fluxnetworks')) {
    ...
    ServerEvents.recipes(event => {
        ...
        event.recipes.gtceu.assembler('fluxnetworks:fluxcore')
            ...
            .itemInputs('1x minecraft:ender_eye', '4x minecraft:obsidian', '4x fluxnetworks:flux_dust', '1x gtceu:luv_sensor', '1x gtceu:luv_emitter', '4x enderio:sculk_superconductor_conduit')
