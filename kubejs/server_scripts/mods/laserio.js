...
ServerEvents.tags("item", event => {
    event.add("moni:card_metal_plate", ["gtceu:tin_plate", "gtceu:tin_alloy_plate"])
    event.add("moni:overclocker_metal_plate", ["gtceu:iron_plate", "gtceu:wrought_iron_plate", "gtceu:steel_plate"])
})
    ...
    overclocker_mats.forEach((value, index) => {
        if(index == 0) {
            ...
            event.recipes.gtceu.assembler(`kubejs:${value[0]}_card`)
                .itemInputs(`3x gtceu:${value[1]}_double_wire`, "6x #moni:overclocker_metal_plate")
            ...
            event.recipes.gtceu.assembler(`kubejs:${value[0]}_card`)
                .itemInputs(`2x gtceu:${value[1]}_double_wire`, `laserio:energy_overclocker_card_tier_${index}`, "6x #moni:overclocker_metal_plate")
                .itemOutputs(`4x laserio:energy_overclocker_card_tier_${index + 1}`)
                .duration(80)
                .EUt(GTValues.VHA[Math.floor(index / 2) + 1])
        }
