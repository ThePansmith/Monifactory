ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.large_chemical_reactor('abyss_crystal_base')
        ...
        .inputFluids('kubejs:void_empowered 576')
    ...
    event.recipes.gtceu.mixer('abyss_crystal_solution')
        ...
        .outputFluids('gtceu:abyss_crystal_solution 1000')
        .duration(300)
        .EUt(GTValues.VHA[GTValues.UEV])

    event.recipes.gtceu.fluid_solidifier('uncut_abyss_crystal')
        .inputFluids('gtceu:abyss_crystal_solution 3000')
    ...
    event.recipes.gtceu.mixer('pure_shards')
        .itemInputs('4x gtceu:diamond_dust', '8x gtceu:lapis_dust', '7x gtceu:redstone_dust', '3x gtceu:emerald_dust', '4x gtceu:nether_quartz_dust', '2x minecraft:prismarine_crystals')
    ...
    event.recipes.gtceu.chemical_bath('pure_crystal_final')
        ...
        .inputFluids('gtceu:empowered_restonia 288')
    ...
    event.recipes.gtceu.mixer('extreme_energy_blend')
        ...
        .inputFluids('gtceu:einsetinium 432', 'gtceu:americium 432')
    ...
    event.recipes.gtceu.autoclave('extreme_energy_crystal')
        ...
        .inputFluids('gtceu:empowered_palis 144')
