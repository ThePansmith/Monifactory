...
ServerEvents.recipes(event => {
    event.recipes.gtceu.assembly_line("kubejs_dischargement_core")
    ...
    event.recipes.gtceu.canner("bathyal_energy_core")
        .itemInputs("kubejs:empty_bathyal_energy_core", "gtceu:sculk_agar_dust")
        .inputFluids("gtceu:sculk 576")
    ...
    event.recipes.gtceu.canner("abyssal_energy_core")
        .itemInputs("kubejs:empty_abyssal_energy_core", "2x gtceu:sculk_agar_dust")
        .inputFluids("gtceu:sculk 1152")
    ...
    event.recipes.gtceu.canner("hadal_energy_core")
        .itemInputs("kubejs:empty_hadal_energy_core", "4x gtceu:sculk_agar_dust")
        .inputFluids("gtceu:hadal_sculk 2304")
