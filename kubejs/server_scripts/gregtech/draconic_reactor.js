ServerEvents.recipes(event => {
    ...
    Reactor('nt_solar', 'kubejs:sp_endgame.neutronium', ['solarflux:sp_de.chaotic', '4x gtceu:draconic_superconductor_single_wire', '2x gtceu:omnium_block'], 'chaotic', 134217600000)
    ...
    Reactor('chaotic_crafting_injector', 'draconicevolution:chaotic_crafting_injector', ['draconicevolution:awakened_crafting_injector', '4x kubejs:neutronium_ingot', '4x draconicevolution:chaos_shard', '2x kubejs:crystal_matrix_block'], 'awakened', 30000000000)
    ...
    Reactor('chaotic_core', 'draconicevolution:chaotic_core', ['minecraft:nether_star', '4x draconicevolution:chaos_shard', '2x kubejs:neutronium_ingot', '2x gtceu:omnium_ingot'], 'chaotic', 30000000000)
