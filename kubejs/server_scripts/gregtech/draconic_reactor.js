ServerEvents.recipes(event => {
    ...
    Reactor('reactor_core', 'kubejs:reactor_core', ['extendedcrafting:the_ultimate_catalyst', '4x gtceu:resonant_sculk_compound_block', '4x kubejs:chaos_shard', '2x kubejs:stabilized_einsteinium'], 'resonant', 26000000000)
    Reactor('abyssal_reaction_casing', 'kubejs:abyssal_reaction_casing', ['kubejs:resonant_reaction_casing', '4x gtceu:neutronium_ingot', '4x kubejs:chaos_shard', '2x gtceu:crystal_matrix_block'], 'resonant', 30000000000)
    ...
    Reactor('reactor_stabilizer', 'kubejs:reactor_stabilizer', ['kubejs:reactor_prt_stab_frame', 'kubejs:reactor_prt_rotor_full', 'kubejs:reactor_prt_focus_ring', '2x kubejs:resonant_energy_core', '4x kubejs:resonant_core'], 'resonant', 56320000000)
    ...
    Reactor('sculk_compound_resonant_block', '5x gtceu:resonant_sculk_compound_block', ['5x gtceu:sculk_compound_block', '4x kubejs:echo_core', '2x kubejs:dragon_heart'], 'echo', 24000000000)
    ...
    Reactor('abyssal_core', 'kubejs:abyssal_core', ['minecraft:nether_star', '4x kubejs:chaos_shard', '2x gtceu:neutronium_ingot', '2x gtceu:omnium_ingot'], 'abyssal', 30000000000)
