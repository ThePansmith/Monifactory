...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.virtual_particle_synthesis("quantum_eye_please_load_i_beg_you")
    ...
    event.recipes.gtceu.virtual_particle_synthesis("meson_g1")
        .itemInputs("2x gtceu:enriched_naquadah_dust")
        .inputFluids(
    ...
    event.recipes.gtceu.virtual_particle_synthesis("meson_g2")
        .itemInputs("2x gtceu:actinium_dust")
        .inputFluids(
            "kubejs:meson_g1 400",
            "kubejs:bosonic_matter 400",
            "kubejs:hadronic_matter 400",
