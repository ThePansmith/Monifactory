...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line("antimatter_manipulator")
        .itemInputs("kubejs:bioalloy_fusion_casing", "#gtceu:circuits/uhv", "2x gtceu:uhv_field_generator", "2x gtceu:double_sculk_bioalloy_plate", "gtceu:gravi_star", "2x gtceu:uhv_emitter", "2x gtceu:uhv_electric_pump", "6x gtceu:neutronium_large_fluid_pipe", "64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire")
    ...
    event.recipes.gtceu.assembly_line("antimatter_collider")
        .itemInputs("6x kubejs:bioalloy_fusion_casing", "8x #gtceu:circuits/uhv", "3x gtceu:dense_trinaquadalloy_plate", "12x gtceu:hsse_frame", "6x solarflux:sp_custom_hadal", "4x gtceu:uhv_field_generator", "6x gtceu:uhv_emitter", "10x gtceu:uhv_electric_pump", "10x gtceu:superconducting_coil", "10x gtceu:neutronium_huge_fluid_pipe", "64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire", "64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire")
