ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('kubejs:naquadah_reactor_i')
        ...
        event.recipes.gtceu.assembly_line('kubejs:large_naquadah_reactor')
            .itemInputs('gtceu:computer_monitor_cover', '4x ae2:spatial_pylon', '#gtceu:circuits/uhv', 'kubejs:omnic_matrix_coil_block', 'gtceu:fusion_coil', '2x gtceu:neutron_reflector', 'gtceu:naquadah_alloy_frame', 'gtceu:uv_sensor', 'gtceu:uv_field_generator', 'gtceu:uv_emitter', '64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire')
            .inputFluids('gtceu:soldering_alloy 1152', 'gtceu:omnium 576')
            .itemOutputs('gtceu:large_naquadah_reactor')
            .duration(1500)
            .EUt(491520)
            .stationResearch(b => b.researchStack(Item.of('gtceu:naquadah_reactor_i')).EUt(524288).CWUt(128,512000))
