ServerEvents.recipes(event => {
    ...
    Reactor('echo_solar', '2x solarflux:sp_custom_echo', ['kubejs:echo_energy_core', '4x solarflux:sp_8', '4x enderio:cryolobus_conduit', '2x gtceu:cryolobus_block'], '0.00001', 8388600000)
    ...
    Reactor('reactor_stabilizer', 'kubejs:reactor_stabilizer', ['kubejs:reactor_prt_stab_frame', '2x kubejs:resonant_energy_core', '4x kubejs:abyssal_core'], '0.00000001', 56320000000)
    Reactor('resonant_energy_core', 'kubejs:resonant_energy_core', ['kubejs:echo_energy_core', '4x gtceu:cryococcus_ingot', '2x kubejs:abyssal_core', '2x gtceu:energy_module', '2x gtceu:restonia_empowered_block'], '0.00000001', 419430000)
