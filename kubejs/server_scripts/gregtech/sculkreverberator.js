ServerEvents.recipes(event => {
    ...
    Reactor('echo_reaction_casing', 'moni_multiblocks:bathyal_coil_block', ['moni_multiblocks:mesol_coil_block', 'kubejs:echo_core', '2x kubejs:sculk_core', 'gtceu:cryolobus_block', '4x minecraft:nether_star'], 'basic', 20480000)
    ...
    Reactor('kubejs_reaction_casing', 'moni_multiblocks:abyssal_coil_block', ['moni_multiblocks:bathyal_coil_block', '2x minecraft:nether_star', '2x kubejs:echo_core', '2x minecraft:dragon_egg'], 'echo', 6000000000)
    ...
    Reactor('resonant_energy_core', 'kubejs:resonant_energy_core', ['kubejs:echo_energy_core', '4x gtceu:cryococcus_ingot', '2x kubejs:resonant_core', '2x gtceu:energy_module', '2x gtceu:restonia_empowered_block'], 'resonant', 419430000)
    Reactor('cryococcus_block', '5x gtceu:cryococcus_block', ['5x gtceu:cryolobus_block', '4x kubejs:echo_core', '2x kubejs:warden_heart'], 'echo', 24000000000)
    Reactor('resonant_core', 'kubejs:resonant_core', ['minecraft:nether_star', '4x kubejs:echo_core', '2x gtceu:cryococcus_block'], 'echo', 3000000000)
