ServerEvents.recipes(event => {
    ...
    Reactor('reactor_core', 'kubejs:reactor_core', ['extendedcrafting:the_ultimate_catalyst', '4x gtceu:cryococcus_block', '4x kubejs:hadal_shard', '2x kubejs:stabilized_einsteinium'], '0.00000001', 26000000000)
    Reactor('abyssal_reaction_casing', 'moni_multiblocks:hadal_coil_block', ['moni_multiblocks:abyssal_coil_block', '4x gtceu:neutronium_ingot', '4x kubejs:hadal_shard', '2x gtceu:crystal_matrix_block'], '0.00000001', 30000000000)
