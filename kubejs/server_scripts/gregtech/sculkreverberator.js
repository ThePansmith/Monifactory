ServerEvents.recipes(event => {
    ...
    Reactor('echo_reaction_casing', 'moni_multiblocks:bathyal_coil_block', ['moni_multiblocks:mesol_coil_block', 'kubejs:echo_core', '2x kubejs:sculk_core', 'gtceu:sculk_compound_block', '4x minecraft:nether_star'], 'basic', 20480000)
