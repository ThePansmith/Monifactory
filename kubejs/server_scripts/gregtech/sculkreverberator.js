ServerEvents.recipes(event => {
    ...
    Reactor('kubejs_reaction_casing', 'moni_multiblocks:abyssal_voltic_casing', ['moni_multiblocks:bathyal_voltic_casing', '2x minecraft:nether_star', '2x kubejs:bathyal_core', '2x minecraft:sculk_catalyst'], '0.00001', 120000000)
    ...
    Reactor('abyssal_core', 'kubejs:abyssal_core', ['gtceu:quantum_star', '4x kubejs:bathyal_core', '2x gtceu:cryococcus_block', 'kubejs:stabilized_einsteinium'], '0.00001', 3000000000)
    Reactor('hadal_core', 'kubejs:hadal_core', ['gtceu:gravi_star', '4x kubejs:hadal_shard', '2x gtceu:neutronium_ingot', '2x gtceu:omnium_ingot'], '0.000000000001', 30000000000)
