ServerEvents.recipes(event => {
    ...
    Reactor('abyssal_solar', '2x solarflux:sp_custom_abyssal', ['kubejs:abyssal_energy_core', '4x solarflux:sp_custom_echo', '4x enderio:sculk_superconductor_conduit', '2x minecraft:bathyal_energy_core'], '0.00000001', 16777200000)
    Reactor('bathyal_solar', '2x solarflux:sp_custom_bathyal', ['kudbejs:bathyal_energy_core', '4x solarflux:sp_8', '4x enderio:cryolobus_conduit', '2x gtceu:cryolobus_block'], '0.00001', 8388600000)
    Reactor('reactor_core', 'kubejs:reactor_core', ['extendedcrafting:the_ultimate_catalyst', '4x gtceu:cryococcus_block', '4x minecraft:echo_shard', '2x kubejs:stabilized_einsteinium'], '0.00000001', 26000000000)
    Reactor('abyssal_reaction_casing', 'moni_multiblocks:hadal_coil_block', ['moni_multiblocks:abyssal_coil_block', '4x gtceu:neutronium_ingot', '4x minecraft:echo_shard', '2x gtceu:crystal_matrix_block'], '0.00000001', 30000000000)
    ...
    Reactor('abyssal_energy_core', 'kubejs:abyssal_energy_core', ['kudbejs:bathyal_energy_core', '4x gtceu:cryococcus_ingot', '2x kubejs:abyssal_core', '2x gtceu:energy_module', '2x gtceu:restonia_empowered_block'], '0.00000001', 419430000)
    ...
    Reactor('hadal_core', 'kubejs:hadal_core', ['minecraft:nether_star', '4x minecraft:echo_shard', '2x gtceu:neutronium_ingot', '2x gtceu:omnium_ingot'], '0.000000000001', 30000000000)
