ServerEvents.recipes(event => {
    ...
    Reactor('abyssal_reaction_casing', 'moni_multiblocks:hadal_coil_block', ['moni_multiblocks:abyssal_coil_block', '4x gtceu:neutronium_ingot', '4x kubejs:hadal_shard', '2x gtceu:crystal_matrix_block', '2x gtceu:void_empowered_crystal'], '0.00000001', 30000000000)
    ...
    Reactor('hadal_warp_engine', 'kubejs:hadal_warp_engine', ['gtceu:cryococcus_frame', 'kubejs:warp_engine', '2x gtceu:cryococcus_plate', '6x gtceu:cryolobus_plate', '2x kubejs:abyssal_core', 'gtceu:zpm_field_generator', 'kubejs:abyssal_energy_core', '2x kubejs:hadal_shard'], '0.000000000001', 30000000000)
