ServerEvents.recipes(event => {
    ...
    Reactor('abyssal_reaction_casing', 'moni_multiblocks:hadal_coil_block', ['moni_multiblocks:abyssal_coil_block', '4x gtceu:neutronium_ingot', '4x kubejs:hadal_shard', '2x gtceu:crystal_matrix_block', '2x gtceu:void_empowered_block'], '0.00000001', 30000000000)
    Reactor('kubejs_reaction_casing', 'moni_multiblocks:abyssal_coil_block', ['moni_multiblocks:bathyal_coil_block', '2x minecraft:nether_star', '2x kubejs:bathyal_core', '2x minecraft:sculk_catalyst'], '0.00001', 6000000000)
