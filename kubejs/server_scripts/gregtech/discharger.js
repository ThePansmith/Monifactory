...
ServerEvents.recipes(event => {
    ...
    Discharge("transcendental_soul", "kubejs:transcendental_soul_vial", ["gtceu:transcendental_will_dust", "enderio:empty_soul_vial", "gtceu:dark_soularium_plate", bathyal], 20000000)
