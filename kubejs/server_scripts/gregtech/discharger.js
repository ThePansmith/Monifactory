ServerEvents.recipes(event => {
    ...
    Discharge('abyssal_solar', '2x solarflux:sp_custom_abyssal', ['kubejs:abyssal_energy_core', '2x solarflux:sp_custom_bathyal', '4x enderio:sculk_superconductor_conduit', '2x kubejs:bathyal_energy_core'], 20000000)
