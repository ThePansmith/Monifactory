...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.forming_press("graphite_electrode")
        ...
        .itemOutputs("2x kubejs:graphite_electrode")
        .duration(7 * 20)
    ...
    event.recipes.gtceu.arc_furnace("nanotube_arcing")
        .chancedInput("2x kubejs:graphite_electrode", 600, 0)
        .inputFluids("gtceu:helium 200")
        .itemOutputs("kubejs:nanotube_soot")
        .duration(40)
        .EUt(GTValues.VA[GTValues.EV])

    event.recipes.gtceu.autoclave("substrate_preparation")
        .itemInputs("4x kubejs:raw_nanotube_substrate", "kubejs:nanotube_soot")
