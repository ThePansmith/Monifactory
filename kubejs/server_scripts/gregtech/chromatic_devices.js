...
ServerEvents.recipes(event => {
    if (doComplexPrismaC) {
        ...
        event.recipes.gtceu.assembly_line("tube")
            ...
            .inputFluids("gtceu:omnium 288", "gtceu:californium 18")
    ...
    if (doComplexPrismaC) {
        event.recipes.gtceu.assembly_line("chromatic_capacitor")
            .itemInputs("gtceu:neutronium_small_fluid_pipe", "3x gtceu:uhv_field_generator", "8x monilabs:transcendental_matrix_foil", "6x gtceu:uhv_sensor", "12x gtceu:stainless_steel_ring")
            .inputFluids("gtceu:omnium 288", "gtceu:polyethyl_cyanoacrylate 288", "gtceu:californium 144")
    ...
    if (doParticleSynthesis) {
        event.recipes.gtceu.discharger("inert_prismatic_core")
            ...
            .inputFluids("gtceu:californium 72")
