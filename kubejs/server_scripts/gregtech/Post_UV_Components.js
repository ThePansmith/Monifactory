...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler("max_64a_substation_dynamo_hatch")
        .itemInputs("gtceu:max_energy_output_hatch_16a", "gtceu:max_machine_hull", "4x gtceu:monium_quadruple_wire", "3x gtceu:monium_hex_wire", "2x gtceu:monium_plate", "2x gtceu:meta_null_plate", "2x kubejs:uxpic_chip", "2x gtceu:monium_spring", "4x gtceu:uev_electric_pump")
