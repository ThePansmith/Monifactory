...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line("uiv_motor")
        .itemInputs("gtceu:long_terbium_rod", "12x gtceu:long_eltz_rod", "12x gtceu:eltz_ring", "24x gtceu:eltz_round", "64x gtceu:fine_holmium_wire", "64x gtceu:fine_holmium_wire", "64x gtceu:fine_holmium_wire", "2x gtceu:holmium_single_wire")
