...
ServerEvents.recipes(event => {
    ...
    // UEV casing and hull are not autogenerated for some reason
    event.recipes.gtceu.shaped("gtceu:uev_machine_casing", [
        "PPP",
        "PWP",
        "PPP"
    ], {
    ...
    }).id("gtceu:shaped/casing_uev")

    event.recipes.gtceu.assembler("casing_uev")
    ...
    event.recipes.gtceu.assembler("hull_uev")
        .itemInputs("gtceu:uev_machine_casing", "2x gtceu:darconite_single_cable")
    ...
    // MAX casing and hull are not autogenerated; casing has slightly different recipe for balancing the relative cost of energy hatches vs full chest.
    event.recipes.gtceu.shaped("gtceu:max_machine_casing", [
        "QPQ",
        "PWP",
        "QPQ"
    ], {
        P: "gtceu:monium_plate",
        Q: "gtceu:double_meta_null_plate",
        W: "#forge:tools/wrenches"
    }).id("gtceu:shaped/casing_max")

    event.recipes.gtceu.assembler("casing_max")
        .itemInputs("4x gtceu:monium_plate", "4x gtceu:double_meta_null_plate")
    ...
    // No idea where the fuck these are generated. Need the ability to edit 'em.
    event.remove({ id: "gtceu:assembler/energy_hatch_4a_max" })
    event.remove({ id: "gtceu:assembler/dynamo_hatch_4a_max" })
    event.recipes.gtceu.assembler("energy_hatch_4a_max")
        .itemInputs("gtceu:max_energy_input_hatch", "2x gtceu:monium_quadruple_wire", "2x gtceu:monium_plate")
        .itemOutputs("gtceu:max_energy_input_hatch_4a")
        .duration(100)
        .EUt(GTValues.VA[GTValues.MAX])
        .addMaterialInfo(true)
    event.recipes.gtceu.assembler("dynamo_hatch_4a_max")
        .itemInputs("gtceu:max_energy_output_hatch", "2x gtceu:monium_quadruple_wire", "2x gtceu:monium_plate")
