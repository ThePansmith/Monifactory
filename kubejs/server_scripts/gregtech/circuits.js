ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.circuit_assembler('kubejs:circuit_assembler/workstation_ev_soldering_alloy')
        ...
        // WIP: Matter Circuits
        // TBD, need to come up with a second mechanic for getting these
        ...
        .itemInputs('kubejs:dimensional_processing_unit', '8x kubejs:complex_smd_capacitor', '4x kubejs:complex_smd_transistor', '4x gtceu:highly_advanced_soc', '4x gtceu:qbit_cpu_chip', '4x gtceu:fine_holmium_wire')
        ...
        .itemInputs( '2x gtceu:neutronium_frame', '2x kubejs:dimensional_processor_computer', '64x kubejs:complex_smd_capacitor', '64x kubejs:complex_smd_transistor', '64x kubejs:complex_smd_diode', '64x kubejs:complex_smd_resistor', '64x kubejs:complex_smd_inductor', '64x kubejs:complex_smd_resistor', '64x gtceu:ram_chip', '8x gtceu:ruthenium_trinium_americium_neutronate_double_wire', '4x gtceu:double_crystal_matrix_plate') // could replace with omnium frame
        .inputFluids('gtceu:soldering_alloy 1152')
