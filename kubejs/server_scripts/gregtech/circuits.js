...
<
        ...
        event.recipes.gtceu.assembly_line('matter_processor_assembly')
            .itemInputs('kubejs:matter_processing_unit', '3x kubejs:matter_processor', '64x kubejs:multidimensional_cpu_chip', 
            '16x gtceu:advanced_smd_capacitor', '16x gtceu:advanced_smd_transistor', '16x gtceu:advanced_smd_diode', '16x gtceu:advanced_smd_resistor', 
            '4x gtceu:enriched_naquadah_trinium_europium_duranide_double_wire')
            .inputFluids('gtceu:soldering_alloy 1152')
        ...
        event.recipes.gtceu.assembly_line('matter_processor_computer')
            .itemInputs('kubejs:matter_processing_unit', '4x kubejs:matter_processor_assembly', '64x kubejs:multidimensional_cpu_chip', 
            '32x gtceu:advanced_smd_capacitor', '32x gtceu:advanced_smd_transistor', '32x gtceu:advanced_smd_diode', '32x gtceu:advanced_smd_resistor', 
            '16x gtceu:uhpic_chip', '4x gtceu:enriched_naquadah_trinium_europium_duranide_double_wire')
        ...
        event.recipes.gtceu.circuit_assembler('dimensional_processor')
            .itemInputs('kubejs:dimensional_processing_unit', '8x kubejs:complex_smd_capacitor', '4x kubejs:complex_smd_transistor', 
            '4x kubejs:multidimensional_cpu_chip', '4x gtceu:fine_holmium_wire')
            .inputFluids('gtceu:soldering_alloy 144')
