...
ServerEvents.recipes(event => {
    ...
    // WIP: Matter Circuits
    let plasticBoard;
    if (doHarderRecipes) plasticBoard = "16x gtceu:polyethyl_cyanoacrylate_plate"
    ...
    event.recipes.gtceu.assembly_line("matter_processor_mainframe")
        ...
        .inputFluids("gtceu:advanced_soldering_alloy 4320", "gtceu:omnium 288")
    ...
    event.recipes.gtceu.assembly_line("dimensional_processor_mainframe")
        ...
        .inputFluids("gtceu:advanced_soldering_alloy 4320", "gtceu:omnium 576")
    ...
    event.recipes.gtceu.assembly_line("monic_processor_mainframe")
        ...
        .inputFluids("gtceu:advanced_soldering_alloy 4320", "gtceu:omnium 1152")
