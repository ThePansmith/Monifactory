...
ServerEvents.recipes(event => {
    ...
    // T9MM mission
    microverse_mission(event, 9, 4, 50, GTValues.VHA, GTValues.UV, 100).forEach(builder => {
        builder
    ...
    // T10MM missions
    microverse_mission(event, 10, 4, 300, GTValues.VA, GTValues.UHV, 75).forEach(builder => {
        builder
            .itemInputs('8x kubejs:infinity_catalyst', 'kubejs:corrupted_universe_data')
            .itemOutputs('16x kubejs:heart_of_a_universe')
    })

    microverse_mission(event, 10, 4, 20, GTValues.VA, GTValues.UHV, 100).forEach(builder => {
        builder
    ...
    // T11MM missions
    microverse_mission(event, 11, 4, 30, GTValues.VA, GTValues.UHV, 100).forEach(builder => {
        builder
    ...
    microverse_mission(event, 11, 4, 30, GTValues.VHA, GTValues.UHV, 100).forEach(builder => {
        builder
            .itemInputs(
    ...
    microverse_mission(event, 11, 4, 30, GTValues.VA, GTValues.UEV, 0).forEach(builder => {
        builder
            .itemInputs(
    ...
    microverse_mission(event, 12, 4, 60, GTValues.VA, GTValues.UIV, 50).forEach(builder => {
        builder
            .itemInputs('64x gtceu:infinity_ingot', '4x kubejs:universe_creation_data')
            .itemOutputs('64x gtceu:monium_ingot')
    })

    microverse_mission(event, 12, 4, 60, GTValues.VA, GTValues.UIV, 0).forEach(builder => {
        builder
            .itemInputs(
    ...
    microverse_mission(event, 12, 4, 60, GTValues.VA, GTValues.UXV, 10).forEach(builder => {
        builder
