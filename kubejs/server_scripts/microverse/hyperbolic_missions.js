ServerEvents.recipes(event => {
    // T4MM mission
    hyperbolic_microverse_mission(event, 4, 30, GTValues.VHA, GTValues.UV, 100, GTValues.MAX).forEach(builder => {
        builder
        .itemInputs('64x kubejs:ultra_dense_hydrogen', '64x kubejs:ultra_dense_hydrogen', '64x kubejs:ultra_dense_hydrogen', '64x kubejs:ultra_dense_hydrogen', '1x gtceu:data_module', '1x gtceu:uhv_sensor')
    ...
    // T6MM mission
    hyperbolic_microverse_mission(event, 6, 25, GTValues.VHA, GTValues.ZPM, 100, GTValues.MAX).forEach(builder => {
        builder
        .itemInputs(
    ...
    // T8MM mission
    hyperbolic_microverse_mission(event, 8, 30, GTValues.VHA, GTValues.UV, 100, GTValues.MAX).forEach(builder => {
        builder
        .itemInputs(
    ...
    // T9MM mission
    hyperbolic_microverse_mission(event, 9, 50, GTValues.VHA, GTValues.UV, 100, GTValues.MAX).forEach(builder => {
        builder
    ...
    hyperbolic_microverse_mission(event, 10, 20, GTValues.VA, GTValues.UHV, 100, GTValues.MAX).forEach(builder => {
        builder
    ...
    // T11MM missions
    hyperbolic_microverse_mission(event, 11, 30, GTValues.VA, GTValues.UHV, 100, GTValues.MAX).forEach(builder => {
        builder
    ...
    hyperbolic_microverse_mission(event, 11, 30, GTValues.VHA, GTValues.UHV, 100, GTValues.MAX).forEach(builder => {
        builder
        .itemInputs(
    ...
    hyperbolic_microverse_mission(event, 12, 60, GTValues.VA, GTValues.UXV, 100, GTValues.MAX).forEach(builder => {
        builder
