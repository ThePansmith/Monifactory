...
ServerEvents.recipes(event => {
    ...
    repairing(1, ["steel"])
        ...
        .chancedInput('kubejs:basic_mining_laser', 2400, -500)
        .chancedInput('kubejs:conductive_iron_thruster', 2000, -700)
        .chancedInput('kubejs:basic_micro_miner_guidance_system', 1000, -500)

    repairing(2, ["titanium"])
        .EUt(GTValues.VHA[GTValues.EV])
        .chancedInput('kubejs:basic_mining_laser', 2800, -600)
        .chancedInput('kubejs:electrical_steel_thruster', 3000, -1000)
        .chancedInput('kubejs:basic_micro_miner_guidance_system', 1500, -750)
        .chancedInput('kubejs:electrum_micro_miner_core', 900, -250)

    repairing("2half", ["dark_steel"])
        .EUt(GTValues.VHA[GTValues.EV])
        .itemInputs('16x minecraft:arrow')
        .chancedInput('kubejs:hardened_thruster', 2000, -700)
        .chancedInput('kubejs:basic_micro_miner_guidance_system', 1500, -750)
        .chancedInput('minecraft:crossbow', 300, -60)

    repairing(3, ["tungsten_carbide"])
        .EUt(GTValues.VA[GTValues.EV])
        .chancedInput('kubejs:reinforced_mining_laser', 2400, -500)
        .chancedInput('kubejs:reinforced_thruster', 3000, -1000)
        .chancedInput('kubejs:basic_micro_miner_guidance_system', 2000, -1000)
        .chancedInput('kubejs:electrum_micro_miner_core', 1800, -500)

    repairing(4, ["signalum", "tungsten_carbide"])
        .EUt(GTValues.VHA[GTValues.IV])
        .chancedInput('kubejs:reinforced_mining_laser', 2800, -600)
        .chancedInput('kubejs:energetic_thruster', 4000, -1400)
        .chancedInput('kubejs:basic_micro_miner_guidance_system', 2500, -1250)
        .chancedInput('kubejs:signalum_micro_miner_core', 1800, -500)

    repairing("4half", ["lumium", "tungsten_carbide"])
        .EUt(GTValues.VHA[GTValues.IV])
        .chancedInput('redstone_arsenal:flux_sword', 2800, -600)
        .chancedInput('kubejs:energetic_thruster', 2000, -700)
        .chancedInput('kubejs:basic_micro_miner_guidance_system', 3000, -1500)
        .chancedInput('kubejs:signalum_micro_miner_core', 1800, -500)

    repairing(5, ["iridium", "signalum"])
        .EUt(GTValues.VA[GTValues.IV])
        .chancedInput('kubejs:supercharged_laser_array', 2400, -500)
        .chancedInput('kubejs:vibrant_thruster', 3000, -1000)
        .chancedInput('kubejs:advanced_micro_miner_guidance_system', 2500, -1000)
        .chancedInput('kubejs:signalum_micro_miner_core', 1800, -500)

    repairing(6, ["enderium"])
        .EUt(GTValues.VHA[GTValues.LuV])
        .chancedInput('kubejs:supercharged_laser_array', 2800, -600)
        .chancedInput('kubejs:resonant_thruster', 3000, -1000)
        .chancedInput('kubejs:advanced_micro_miner_guidance_system', 3000, -1000)
        .chancedInput('kubejs:enderium_micro_miner_core', 1800, -500)

    repairing(7, ["cryolobus"])
        .EUt(GTValues.VA[GTValues.LuV])
        .chancedInput('kubejs:supercharged_laser_array', 4000, -800)
        .chancedInput('kubejs:dark_soularium_thruster', 4000, -1400)
        .chancedInput('kubejs:fluxed_thruster', 4000, -1400)
        .chancedInput('kubejs:advanced_micro_miner_guidance_system', 3500, -1200)
        .chancedInput('kubejs:enderium_micro_miner_core', 1800, -500)
        .chancedInput('kubejs:bathyal_energy_core', 1000, -250)

    repairing(8, ["crystal_matrix", "tungsten_carbide", "iridium"])
        .EUt(GTValues.VA[GTValues.ZPM])
        .chancedInput('kubejs:supercharged_laser_array', 4800, -1000)
        .chancedInput('kubejs:warp_engine', 5000, -1500)
        .chancedInput('kubejs:advanced_micro_miner_guidance_system', 4000, -1200)
    ...
    repairing("8half", ["trinium", "naquadah_alloy"])
        ...
        .chancedInput('kubejs:supercharged_laser_array', 4800, -1000)
        .chancedInput('kubejs:warp_engine', 5000, -1500)
        .chancedInput('kubejs:advanced_micro_miner_guidance_system', 4500, -1200)
        .chancedInput('kubejs:warp_core', 2500, -500)
