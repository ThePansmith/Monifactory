...
ServerEvents.recipes(event => {
    // T4MM missions
    microverse_mission(event, 4, 2, 160, GTValues.VHA, GTValues.IV, 100).forEach(builder => {
        builder
    ...
    microverse_mission(event, 4, 2, 60, GTValues.VHA, GTValues.IV, 100).forEach(builder => {
        builder
            .itemInputs('4x kubejs:quantum_flux')
            .itemInputs('16x kubejs:petrotheum_dust')
            .itemInputs(
    ...
    // T5MM missions
    microverse_mission(event, 5, 2, 200, GTValues.VA, GTValues.IV, 100).forEach(builder => {
        if(isNormalMode) {
            builder
    ...
    // T6MM missions
    microverse_mission(event, 6, 2, 240, GTValues.VHA, GTValues.LuV, 100).forEach(builder => {
        builder
