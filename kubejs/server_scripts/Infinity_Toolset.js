...
ServerEvents.recipes(event => {
	...
	event.recipes.gtceu.assembly_line('infinity_toolset/ultimate_hammer_handle')
		.itemInputs('2x armorplus:the_ultimate_material', '10x enderio:reinforced_obsidian_block', '4x gtceu:gravi_star', '4x draconicevolution:chaotic_core', 'gtceu:ultimet_hammer', 'gtceu:wrought_iron_hammer', 'gtceu:tungsten_carbide_hammer', 'gtceu:damascus_steel_hammer', 'gtceu:tungsten_steel_hammer', 'gtceu:cobalt_brass_hammer', 'gtceu:vanadium_steel_hammer', 'gtceu:naquadah_alloy_hammer', 'gtceu:red_steel_hammer', 'gtceu:blue_steel_hammer', 'gtceu:hsse_hammer', 'gcyr:bisalloy_400_hammer')
        .inputFluids('gtceu:soldering_alloy 5760', 'gtceu:neutronium 1152', 'gtceu:crystal_matrix 5760', 'gtceu:naquadria 1152')
	...
	event.recipes.gtceu.assembly_line('infinity_toolset/ultimate_screwdriver_head')
		.itemInputs('2x armorplus:the_ultimate_material', '10x enderio:reinforced_obsidian_block', '4x gtceu:gravi_star', '4x draconicevolution:chaotic_core', 'gtceu:aluminium_screwdriver', 'gtceu:iron_screwdriver', 'gtceu:titanium_screwdriver', 'gtceu:neutronium_screwdriver', 'gtceu:duranium_screwdriver', 'gtceu:bronze_screwdriver', 'gtceu:diamond_screwdriver', 'gtceu:invar_screwdriver', 'gtceu:sterling_silver_screwdriver', 'gtceu:rose_gold_screwdriver', 'gtceu:stainless_steel_screwdriver', 'gtceu:steel_screwdriver')
        .inputFluids('gtceu:soldering_alloy 5760', 'gtceu:neutronium 1152', 'gtceu:crystal_matrix 5760', 'gtceu:naquadria 1152')
	...
	// Ultimate Wrench Head
		...
		.itemInputs('2x armorplus:the_ultimate_material', '10x enderio:reinforced_obsidian_block', '4x gtceu:gravi_star', '4x draconicevolution:chaotic_core', 'gtceu:aluminium_wrench', 'gtceu:iron_wrench', 'gtceu:titanium_wrench', 'gtceu:neutronium_wrench', 'gtceu:duranium_wrench', 'gtceu:bronze_wrench', 'gtceu:diamond_wrench', 'gtceu:invar_wrench', 'gtceu:sterling_silver_wrench', 'gtceu:rose_gold_wrench', 'gtceu:stainless_steel_wrench', 'gtceu:steel_wrench')
        .inputFluids('gtceu:soldering_alloy 5760', 'gtceu:neutronium 1152', 'gtceu:crystal_matrix 5760', 'gtceu:naquadria 1152')
	...
	event.recipes.gtceu.assembly_line('infinity_toolset/ultimate_wrench_handle')
		.itemInputs('2x armorplus:the_ultimate_material', '10x enderio:reinforced_obsidian_block', '4x gtceu:gravi_star', '4x draconicevolution:chaotic_core', 'gtceu:ultimet_wrench', 'gtceu:wrought_iron_wrench', 'gtceu:tungsten_carbide_wrench', 'gtceu:damascus_steel_wrench', 'gtceu:tungsten_steel_wrench', 'gtceu:cobalt_brass_wrench', 'gtceu:vanadium_steel_wrench', 'gtceu:naquadah_alloy_wrench', 'gtceu:red_steel_wrench', 'gtceu:blue_steel_wrench', 'gtceu:hsse_wrench', 'gcyr:bisalloy_400_wrench')
        .inputFluids('gtceu:soldering_alloy 5760', 'gtceu:neutronium 1152', 'gtceu:crystal_matrix 5760', 'gtceu:naquadria 1152')
	...
	event.recipes.gtceu.assembly_line('infinity_toolset/ultimate_wire_cutter_head')
		.itemInputs('2x armorplus:the_ultimate_material', '10x enderio:reinforced_obsidian_block', '4x gtceu:gravi_star', '4x draconicevolution:chaotic_core', 'gtceu:aluminium_wire_cutter', 'gtceu:iron_wire_cutter', 'gtceu:titanium_wire_cutter', 'gtceu:neutronium_wire_cutter', 'gtceu:duranium_wire_cutter', 'gtceu:bronze_wire_cutter', 'gtceu:diamond_wire_cutter', 'gtceu:invar_wire_cutter', 'gtceu:sterling_silver_wire_cutter', 'gtceu:rose_gold_wire_cutter', 'gtceu:stainless_steel_wire_cutter', 'gtceu:steel_wire_cutter')
        .inputFluids('gtceu:soldering_alloy 5760', 'gtceu:neutronium 1152', 'gtceu:crystal_matrix 5760', 'gtceu:naquadria 1152')
    ...
    event.recipes.gtceu.assembly_line('infinity_toolset/infinity_power_unit')
        ...
        .duration(1200)
        .EUt(1966080)
    event.recipes.gtceu.assembly_line('infinity_toolset/omni_motor')
