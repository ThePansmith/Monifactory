...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('gtceu:assembly_line/conveyor_module_luv')
        .itemInputs(Item.of('gtceu:luv_electric_motor',2),Item.of('gtceu:hsss_round',16),Item.of('gtceu:hsss_plate',2),Item.of('gtceu:hsss_screw',4),Item.of('gtceu:hsss_ring',4),Item.of('gtceu:hsss_rotor',1),Item.of('gtceu:niobium_titanium_single_cable',2))
