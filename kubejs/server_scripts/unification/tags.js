...
const unifyChisel = (event) => {
    ...
    event.add(
        ...
        /^chipped:.+(?!_mossy)_cobblestone(_bricks)?$/
    );
    event.add(
        "forge:cobblestone/mossy",
        /^chipped:.+_mossy_cobblestone(_bricks)?$/
    );
    ...
    event.add("forge:storage_blocks", [
        IRON_BLOCKLIKES,
        GOLD_BLOCKLIKES,
        /^chipped:.+_diamond_block$/,
        /^chipped:.+_emerald_block$/,
        /^chipped:.+_glowstone$/,
        /^chipped:.+_lapis_block$/,
        /^chipped:.+_redstone_block$/,
    ]);
...
ServerEvents.tags("block", (event) => {
    // snad
    const compacted_sand = [
        "kubejs:compressed_sand",
        "kubejs:double_compressed_sand",
        "kubejs:compressed_red_sand",
        "kubejs:double_compressed_red_sand",
    ];
