...
ServerEvents.recipes(event => {
    ...
    const wire_forms = [
        {multiplier:"single", quantity: 1},
        {multiplier:"double", quantity: 2},
        {multiplier:"quadruple", quantity: 4},
        {multiplier:"octal", quantity: 8},
        {multiplier:"hex", quantity: 16}
    ]
    ...
    event.recipes.gtceu.vacuum_freezer("sculk_superconductor_double")
    ...
    event.recipes.gtceu.vacuum_freezer("sculk_superconductor_single")
    ...
    wire_forms.forEach((value) => {
        ...
        event.recipes.gtceu.electric_blast_furnace(`hyperdegenerate_darconite_${value.multiplier}_wire`)
            .itemInputs(Item.of(`gtceu:darconite_${value.multiplier}_wire`))
            .itemOutputs(Item.of(`gtceu:hyperdegenerate_darconite_${value.multiplier}_wire`))
            .inputFluids(Fluid.of("gtceu:hyperdegenerate_matter", 10 * value.quantity))
            .duration(20 * value.quantity)
