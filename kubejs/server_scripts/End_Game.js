...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line("knowledge_transmission_array")
        .itemInputs("2x monilabs:sculk_bioalloy_frame", "16x gtceu:europium_double_cable", "16x gtceu:uhv_emitter", "12x kubejs:photonic_stabilizer", "16x gtceu:data_transmitter_hatch", "2x #gtceu:circuits/uhv", "32x gtceu:normal_optical_pipe", "16x gtceu:ruthenium_trinium_americium_neutronate_single_wire", "2x gtceu:network_switch", "32x gtceu:rhodium_foil")
    ...
    if (doParticleSynthesis) {
        ...
        event.recipes.gtceu.assembler("omnic_matrix_plating")
            .itemInputs("gtceu:double_omnium_plate", "2x monilabs:crystal_matrix_plate", "2x gtceu:gravi_star", "gtceu:neutron_reflector", "4x kubejs:primal_mana")
            .inputFluids("kubejs:gluon_g2 200") // Universe's Strongest Glue(TM)
            .duration(100)
        ...
        event.recipes.gtceu.assembler("fieldstabilizedcompound")
            ...
            .inputFluids("kubejs:higgs_g3 1000") // Gravity In A Bottle(TM)
        ...
        event.recipes.gtceu.assembler("kubejs:assembler_dark_soularium_thruster")
            ...
            .inputFluids("kubejs:higgs_g1 1000") // Gravity In A Bottle(TM)
