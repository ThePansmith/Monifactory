ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line('extra_large_chemical_reactor')
            .itemInputs('gtceu:large_chemical_reactor', "16x gtceu:neutronium_large_fluid_pipe", '16x gtceu:uhv_hermetic_casing', '4x gtceu:uv_field_generator', '8x gtceu:uv_electric_pump', '8x gtceu:uv_fluid_regulator', '4x #gtceu:circuits/uhv')
