...
GTCEuStartupEvents.registry("gtceu:machine", event => {
    ...
    if (doHNN) {
        ...
        event.create("simulation_supercomputer", "multiblock")
            ...
            .appearanceBlock(() => new Block.getBlock("monilabs:dark_steel_casing"))
            .pattern(definition => FactoryBlockPattern.start()
                ...
                .where("C", Predicates.blocks("monilabs:dark_steel_casing").setMinGlobalLimited(15)
        ...
        event.create("simulation_quantumcomputer", "multiblock")
            ...
            .pattern(definition => FactoryBlockPattern.start()
                ...
                .where("C", Predicates.blocks("monilabs:dark_steel_casing").setMinGlobalLimited(40)
                    .or(Predicates.autoAbilities(definition.getRecipeTypes()))
    ...
    event.create("greenhouse", "multiblock")
        ...
        .recipeModifiers([MoniRecipeModifiers.OC_AS_PARALLELS])
        .pattern(definition => FactoryBlockPattern.start()
