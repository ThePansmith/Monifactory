...
.aisle("CCCCC", "C#I#C", "G###G", "G###G", "G###G", "C#I#C", "CCCCC")
.aisle("CCCCC", "CIMIC", "C###C", "CIFIC", "C###C", "CIMIC", "CCCCC")
.aisle("CCCCC", "C#I#C", "G###G", "G###G", "G###G", "C#I#C", "CCCCC")
.aisle("#CSC#", "#GGG#", "#GGG#", "#GGG#", "#GGG#", "#GGG#", "#CCC#")
.where('S', Predicates.controller(Predicates.blocks(definition.get())))
.where('C', Predicates.blocks('kubejs:draconium_casing')
    .or(Predicates.autoAbilities(definition.getRecipeTypes())))
...
.where('#', Predicates.air())
    .build())
.workableCasingRenderer("kubejs:block/draconium_casing",
    "gtceu:block/multiblock/implosion_compressor", false)
