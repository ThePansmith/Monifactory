...
GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('discharger', 'multiblock')
        ...
        .aisle("  CCCCCCC  ", "  CCCCCCC  ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "  CCCCCCC  ", "  CCCCCCC  ")
        .aisle(" CCCCCCCCC ", " CCCSCSCCC ", "  CG C GC  ", "  CG C GC  ", "  CG   GC  ", "  CG   GC  ", "  CG   GC  ", "  CG C GC  ", "  CG C GC  ", " CCCSCSCCC ", " CCCCCCCCC ")
        .aisle(" CCCCCCCCC ", " CCSSSSSCC ", "  G     G  ", "  G     G  ", "  G  S  G  ", "  G     G  ", "  G  S  G  ", "  G     G  ", "  G     G  ", " CCSSSSSCC ", " CCCCCCCCC ")
        .aisle("CCCCCCCCCCC", "CCSSCSCSSCC", " G  CFC  G ", " G       G ", " G       G ", " G       G ", " G       G ", " G       G ", " G  CFC  G ", "CCSSCSCSSCC", "CCCCCCCCCCC")
        .aisle("CCCCCCCCCCC", "CCCSSCSSCCC", " GC FCF CG ", " GC  C  CG ", " G S C S G ", " G   T   G ", " G S C S G ", " GC  C  CG ", " GC FCF CG ", "CCCSSCSSCCC", "CCCCCCCCCCC")
        .aisle("CCCCCCCCCCC", "CCSSCSCSSCC", " G  CFC  G ", " G       G ", " G       G ", " G       G ", " G       G ", " G       G ", " G  CFC  G ", "CCSSCSCSSCC", "CCCCCCCCCCC")
        .aisle(" CCCCCCCCC ", " CCSSSSSCC ", "  G     G  ", "  G     G  ", "  G  S  G  ", "  G     G  ", "  G  S  G  ", "  G     G  ", "  G     G  ", " CCSSSSSCC ", " CCCCCCCCC ")
        .aisle(" CCCCCCCCC ", " CCCSCSCCC ", "  CG C GC  ", "  CG C GC  ", "  CG   GC  ", "  CG   GC  ", "  CG   GC  ", "  CG C GC  ", "  CG C GC  ", " CCCSCSCCC ", " CCCCCCCCC ")
        .aisle("  CCCCCCC  ", "  CCCCCCC  ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "    GGG    ", "  CCCCCCC  ", "  CCCCCCC  ")
