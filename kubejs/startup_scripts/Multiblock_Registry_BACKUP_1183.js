...
>>>>>>> upstream/main
    ...
    event.create('naquadah_reactor_i', 'multiblock')
        ...
        .generator(true)
<<<<<<< HEAD
        .recipeModifiers([GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic(2, 2))]) //required to function.. Probably so it can output energy and take items in at the same time? Not entirely sure. But it made it functional! Yippie
=======
...
>>>>>>> upstream/main
    ...
    event.create('naquadah_reactor_ii', 'multiblock')
        ...
        .generator(true)
<<<<<<< HEAD
        .recipeModifiers([GTRecipeModifiers.ELECTRIC_OVERCLOCK.apply(OverclockingLogic(2, 2))])
=======
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH])
>>>>>>> upstream/main
        .pattern(definition => FactoryBlockPattern.start()
...
>>>>>>> upstream/main
    ...
    event.create("mega_alloy_blast_smelter", "multiblock", (holder) => new $CoilWorkableElectricMultiblockMachine(holder))
        ...
        .recipeModifiers([(machine, recipe) => GTRecipeModifiers.reduction(recipe, 1, 0.7), GTRecipeModifiers.SUBTICK_PARALLEL, GTRecipeModifiers.PARALLEL_HATCH, (machine, recipe) => GTRecipeModifiers.ebfOverclock(machine, recipe)])
