...
GTCEuStartupEvents.registry("gtceu:material", event => {
    if (doHarderProcessing) GTMaterials.RhodiumSulfate.setProperty($PropertyKey.DUST, new $DustProperty());
    if (doStabMiners) GTMaterials.Iridium.addFlags(GTMaterialFlags.GENERATE_DENSE)
    if (!doCreativeTank) {
